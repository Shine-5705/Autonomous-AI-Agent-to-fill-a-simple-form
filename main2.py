...
openai.api_key = 'sk-proj-GBKgTTsd21I3JXSE3oT1T3BlbkFJhCMz1LYC0zifo6nZtSbT'
...
driver.find_element(By.XPATH, '//*[@id="input_13_full"]').send_keys("8433135192")
...
# Upload a resume
driver.find_element(By.XPATH, '//*[@id="input_17"]').send_keys('Shine resume_.pdf')  # Make sure to specify the correct path to your resume file
